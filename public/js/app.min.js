...
define('text-2.0.10',['module'], function (module) {
    'use strict';
...
define("underscore-1.5.1", (function (global) {
    return function () {
        var ret, fn;
        return ret || global._;
    };
...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define('backbone-1.1.2',['underscore', 'jquery', 'exports'], function(_, $, exports) {
...
(function (root, factory) {
  if (typeof exports === "object" && exports) {
    ...
    factory(mustache);
    if (typeof define === "function" && define.amd) {
      define('mustache-1.0.0',mustache); // AMD
    } else {
